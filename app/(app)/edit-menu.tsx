...
export default function EditMenuItem() {
    ...
    const menu: MenuType = menuData.find((item: MenuType) => item?.id === id);
            ...
            <SafeAreaView>
                ...
                <ScrollView contentContainerStyle={{ paddingTop: 16 }}>
                    <YStack gap={16}>
                        ...
                        <Button onPress={onSubmit} theme={'active'}>Update</Button>
                    </YStack>
                </ScrollView>
            </SafeAreaView>
        </YStack>
